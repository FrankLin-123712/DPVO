...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", type=Path, default=REPO_ROOT / "testdata/fp32/patchify_replay_euroc_mh01_first16_p16")
    ...
    if args.nn_fp16_weights:
        print("Overriding YAML NN_FP16_WEIGHTS=True: patchify replay captures use FP32 weights.")
    args.nn_fp16_weights = False
